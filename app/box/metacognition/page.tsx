...
export default function MetacognitionPage() {
  ...
  return (
    <div className="bg-[#0a0a0a] h-dvh w-full flex flex-col overflow-hidden">
      ...
      {/* Main content area */}
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden pt-16 relative">
        
        {/* Centered middle section - Clarifying Question + Google Button */}
        ...
        {/* Chat area - scrollable, top section */}
